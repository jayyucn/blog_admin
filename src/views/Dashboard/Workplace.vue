...
const getCount = async () => {
  ...
  if (res) {
    totalSate = Object.assign(totalSate, res.result)
  }
}
...
const getProject = async () => {
  ...
  if (res) {
    projects = Object.assign(projects, res.result)
  }
}
...
const getDynamic = async () => {
  ...
  if (res) {
    dynamics = Object.assign(dynamics, res.result)
  }
}
...
const getTeam = async () => {
  ...
  if (res) {
    team = Object.assign(team, res.result)
  }
}
    ...
    set(radarOptionData, 'series', [
      {
        ...
        data: [
          {
            value: res.result.map((v) => v.personal),
            name: t('workplace.personal')
          },
          {
            value: res.result.map((v) => v.team),
